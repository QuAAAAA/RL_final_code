...
\begin{itemize}
    ...
    \item \textbf{IndexTTS2 + FT + GRPO}: A target-language adaptation baseline using a lightweight adaptation strategy, used to test whether preserving more pretrained parameters helps retain emotional expressiveness.
    \item \textbf{IndexTTS2 + FT + GRPO + emphasis + va (Ours)}: Our full method, which applies RL-based emotional and prosodic alignment after low-resource adaptation.
