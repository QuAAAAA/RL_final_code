...
\begin{itemize}
    \item \textbf{Original High-Resource IndexTTS2}: The expressive source model before low-resource adaptation, used to establish the upper bound of emotional capability prior to transfer.
    ...
    \item \textbf{CosyVoice2} \citep{Du2024CosyVoice2S}: A strong zero-shot text-to-speech baseline with predefined emotion instructions for cross-model comparison.
